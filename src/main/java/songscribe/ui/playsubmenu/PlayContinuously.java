...
class PlayContinuously extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        playMenu.getMainFrame().getProperties().setProperty(Constants.PLAY_CONTINUOUSLY_PROP, ((AbstractButton) e.getSource()).isSelected() ? Constants.TRUE_VALUE : Constants.FALSE_VALUE);
