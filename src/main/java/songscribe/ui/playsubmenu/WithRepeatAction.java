...
class WithRepeatAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        playMenu.getMainFrame().getProperties().setProperty(Constants.WITH_REPEAT_PROP, ((AbstractButton) e.getSource()).isSelected() ? Constants.TRUE_VALUE : Constants.FALSE_VALUE);
