...
public class InstrumentDialog extends MyDialog{
    ...
    protected void getData() {
        instrumentList.setSelectedIndex(Integer.parseInt(mainFrame.getProperties().getProperty(Constants.INSTRUMENTPROP)));
        instrumentList.ensureIndexIsVisible(instrumentList.getSelectedIndex());
    }

    protected void setData() {
        mainFrame.getProperties().setProperty(Constants.INSTRUMENTPROP, Integer.toString(instrumentList.getSelectedIndex()));
