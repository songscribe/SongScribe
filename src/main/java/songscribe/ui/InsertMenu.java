...
public class InsertMenu extends JMenu {
    ...
    public InsertMenu(MainFrame mainFrame) {
        ...
        subMenus = new InsertSubMenu[] {
                new NoteMenu(mainFrame), new RestMenu(mainFrame), new OtherMenu(mainFrame), new DotMenu(mainFrame),
                new AccidentalMenu(mainFrame), new ArticulationMenu(mainFrame)
        };
