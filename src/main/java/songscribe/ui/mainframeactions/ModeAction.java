...
public class ModeAction extends MultiAccessibleAction{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        mainFrame.getControlMenu().setEnabled(mode==MusicSheet.Mode.NOTEEDIT);
        mainFrame.getStatusBar().setModeLabel(mode.getDescription());
        if(mode!=MusicSheet.Mode.NOTEEDIT) mainFrame.setSelectedTool(mainFrame.getSelectSelectionPanel());
    }
}
