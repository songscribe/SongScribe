...
public class AnnotationAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(sel==null){
            JOptionPane.showMessageDialog(mainFrame, "You must select a note first to annotate it. It can be even a repeat or a vertical line.",
                        mainFrame.PROGNAME, JOptionPane.INFORMATION_MESSAGE);
        }else{
            if(annotationDialog==null)annotationDialog = new AnnotationDialog(mainFrame);
