...
public class BeatChangeAction extends AbstractAction{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(sel==null){
            JOptionPane.showMessageDialog(mainFrame, "You must select a note first from which the beat change should be applied.",
                        mainFrame.PROGNAME, JOptionPane.INFORMATION_MESSAGE);
        }else{
            if(beatChangeDialog==null)beatChangeDialog = new BeatChangeDialog(mainFrame);
