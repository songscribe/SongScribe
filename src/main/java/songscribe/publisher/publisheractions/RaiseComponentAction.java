 ...
 * @author Csaba Kávai
 */
public class RaiseComponentAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (pc != null) {
            publisher.getBook().getSelectedComponentsPage().raiseComponent(pc);
            publisher.getBook().repaintWhole();
        }
        else {
            JOptionPane.showMessageDialog(publisher, "You must select a component first to raise it.");
        }
    }
}
