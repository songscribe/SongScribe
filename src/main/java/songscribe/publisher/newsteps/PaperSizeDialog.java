...
public class PaperSizeDialog extends MyDialog {
    ...
    protected void getData() throws DoNotShowException {
        ...
        paperSizePanel.setValues(book.getPageSize().width, book.getPageSize().height, book.getLeftInnerMargin(), book.getRightOuterMargin(), book.getTopMargin(), book.getBottomMargin(), book.isMirroredMargin());
    }
