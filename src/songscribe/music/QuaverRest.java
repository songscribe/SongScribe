...
public class QuaverRest extends Note {
    public static final Image IMAGE = MainFrame.getImage("quaverRest.gif");
    public static final Rectangle REALNOTERECT = new Rectangle(0, 22, 9, 15);
