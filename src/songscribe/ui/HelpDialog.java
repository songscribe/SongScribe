...
public class HelpDialog extends MyDialog implements ListCellRenderer, ListSelectionListener {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        ((JComponent)lo.component).setBackground(index%2==0 ? Color.white : new Color(238, 246, 255));
        ((JLabel)((JPanel)lo.component).getComponent(0)).setForeground(Color.black);
        if(isSelected){
            ((JComponent)lo.component).setBackground(Color.blue);
            ((JLabel)((JPanel)lo.component).getComponent(0)).setForeground(Color.white);
