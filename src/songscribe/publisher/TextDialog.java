...
public class TextDialog extends MyDialog {
    ...
    public TextDialog(Publisher publisher, boolean isInsert) {
        ...
        fontCombo = new JComboBox(Publisher.FONTFAMILIES);
        ...
        if(isInsert)southPanel.remove(applyButton);
    ...
    protected void getData() {
        ...
        if(pc!=null && pc instanceof Text){
            ...
            switch(text.getAlignment()){
                case LEFT: leftAlign.setSelected(true);break;
                case CENTER: centerAlign.setSelected(true);break;
                case RIGHT: rightAlign.setSelected(true);
            }
    ...
    private Text.Alignment getSelectedAlignment(){
        ...
        if(centerAlign.isSelected())alignment = Text.Alignment.CENTER;
        else if(rightAlign.isSelected())alignment = Text.Alignment.RIGHT;
        return alignment;
    }
}
